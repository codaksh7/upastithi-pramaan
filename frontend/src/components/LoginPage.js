...
export default function LoginPage() {
  ...
  /* form slide-in when role selected */
  useEffect(() => {
  ...
  const submitClass = role === 'faculty' ? 'login__submit login__submit-faculty' : 'login__submit login__submit-student';
          ...
          {!role && (
            <div>
              ...
              <div className="login__admin-link-wrap">
                <button className="login__admin-link" onClick={() => selectRole('admin')}>Admin Access →</button>
              </div>
            </div>
          )}
